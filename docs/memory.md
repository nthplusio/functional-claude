...
| resend-cli | 0.2.1 | Resend CLI and MCP integration for sending emails, managing domains, contacts, broadcasts, templates, webhooks, API keys, and segments with per-project configuration |
