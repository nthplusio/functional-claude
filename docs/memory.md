...
|--------|---------|-------------|
| wezterm-dev | 0.7.3 | WezTerm terminal configuration and customization |
| hyper-dev | 0.2.3 | Hyper terminal configuration and plugin development |
