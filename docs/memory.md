...
| project-manager | 0.11.2 | Project manager for multi-project workflows — per-repo GitHub credentials, Linear issue lifecycle, branch naming, PR linking, and session briefings |
| resend-cli | 0.1.0 | Resend CLI integration for sending emails, managing domains, contacts, broadcasts, templates, webhooks, API keys, and segments from the terminal |
...
## claude-plugin-dev Plugin (v0.6.0)
