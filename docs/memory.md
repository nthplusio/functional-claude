...
| resend-cli | 0.2.0 | Resend CLI and MCP integration for sending emails, managing domains, contacts, broadcasts, templates, webhooks, API keys, and segments with per-project configuration |
